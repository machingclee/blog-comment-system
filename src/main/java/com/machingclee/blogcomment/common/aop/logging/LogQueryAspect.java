package com.machingclee.blogcomment.common.aop.logging;
...
public class LogQueryAspect {
    ...
    @Around("@annotation(com.machingclee.blogcomment.common.aop.logging.LogQuery)")
    public Object logQueries(ProceedingJoinPoint joinPoint) throws Throwable {
        return enableSqlLogging(joinPoint);
    }

    @Around("@within(com.machingclee.blogcomment.common.aop.logging.LogQuery)")
